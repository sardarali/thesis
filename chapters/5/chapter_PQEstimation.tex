...
\centering \scriptsize
	\subfloat[A subnet containing 2 devices.]{\includegraphics[width=0.50\textwidth]{subnet_1}}\qquad
	\subfloat[Subnet as a single power transition matrix.]{\includegraphics[width=0.44\textwidth]{subnet_2}}\\
	\subfloat[Power transition matrix of each device $d_j$.]{\includegraphics[width=0.80\textwidth]{subnet_3}}
...
\begin{table}[!t]
\centering \caption{Transition Functions of Various Electrical Components~\cite{catherine_pri}} \label{tbl:dev_trans}
...
\hline
\multirow{5}{*}{\rotatebox{90}{Input PQ}}& Class 1 &  0.6	&	0.1	&	0.1	&	0.1	& 0.1 \\
& Class 2 & 0.4	&	0.3	&	0.1	&	0.1	& 0.1\\
& Class 3 & 0.4	&	0.1	&	0.3	&	0.1	& 0.1\\
& Class 4 & 0.4	&	0.1	&	0.1	&	0.3	& 0.1\\
& Class 5 & 0.4	&	0.1	&	0.1	&	0.1	& 0.3\\
\hline
\end{tabular}
}
...
& & Class 1 & Class 2 & Class 3 & Class 4 & Class 5 \\
\hline
\multirow{5}{*}{\rotatebox{90}{Input PQ}}& Class 1 &  0.85	&	0	&	0	&	0	& 0.15 \\
& Class 2 & 0.35	&	0.50	&	0.15	&	0		& 0\\
& Class 3 & 0.20	&	0.15	&	0.50	&	0.15	& 0\\
& Class 4 & 0.20	&	0		&	0.15	&	0.50	& 0.15\\
& Class 5 & 0.35	&	0		&	0		&	0.15	& 0.50\\
\hline
\end{tabular}
}
...
& & Class 1 & Class 2 & Class 3 & Class 4 & Class 5 \\
\hline
\multirow{5}{*}{\rotatebox{90}{Input PQ}}& Class 1 &  1	&	0	&	0	&	0	& 0 \\
& Class 2 & 0.1	&	0.9	&	0	&	0	& 0 \\
& Class 3 & 0.1	&	0	&	0.9	&	0	& 0 \\
& Class 4 & 0.1	&	0	&	0	&	0.9	& 0 \\
& Class 5 & 0.1	&	0	&	0	&	0	& 0.9 \\
\hline
\end{tabular}
}
...
\hline
\multirow{5}{*}{\rotatebox{90}{Input PQ}}& Class 1 &  1	&	0	&	0	&	0	& 0 \\
& Class 2 & 0.8	&	0.2	&	0	&	0	& 0 \\
& Class 3 & 0.8	&	0	&	0.2	&	0	& 0 \\
& Class 4 & 0.8	&	0	&	0	&	0.2	& 0 \\
& Class 5 & 0.8	&	0	&	0	&	0	& 0.2 \\
\hline
\end{tabular}
}
\end{table}
...
\begin{figure}[!t]
\centering \scriptsize
	\subfloat{\includegraphics[width=0.21\columnwidth]{s1}}\qquad\qquad
	\subfloat{\includegraphics[width=0.34\columnwidth]{s2}}
