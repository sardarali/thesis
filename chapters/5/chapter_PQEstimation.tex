...
\begin{table}[!t]
\vspace{-0.05in}
\scriptsize \centering \caption{Transition Functions of Various Electrical Components Obtained Using Our Latent Feature Model} \vspace{-0.15in} \label{tbl:dev_trans}
\renewcommand{\tabcolsep}{0.16 cm}
\subfloat[Bus]{
...
\renewcommand{\tabcolsep}{0.146 cm}
