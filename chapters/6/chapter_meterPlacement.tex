...
\begin{algorithm}[!p]
\setstretch{2}
\KwIn{distribution function of input link to device 1 i.e., $f_x^{(0)}$, \\transfer function $f(d)$, number of power meters $M$}
...
\begin{figure}[!p]
\centering
\includegraphics[width=0.8\columnwidth]{flowchart_worst_predicted_error}
...
\begin{figure}[!p]
\centering
\includegraphics[width=0.98\columnwidth]{factorgraph}
...
\begin{figure}[!p]
\centering
\includegraphics[width=0.6\textwidth]{benchmark}
