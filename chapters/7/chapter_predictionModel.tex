...
\includegraphics[width=0.7\columnwidth]{corr_positive}
}

\vspace{1cm}

\subfloat[Zero correlation ($\rho_{X,Y} = 0$)]{\label{corr_zero}
\includegraphics[width=0.7\columnwidth]{corr_zero}
}
...
\includegraphics[width=0.7\columnwidth]{corr_negative_low}
}

\vspace{1cm}

\subfloat[Negative correlation ($\rho_{X,Y} = -1$)]{\label{corr_negative_high}
\includegraphics[width=0.7\columnwidth]{corr_negative_high}
}
\vspace{1cm}
